;; Cacao-theme.el --- a theme based on an accidental image reverse I did   -*-lexical-binding: t; -*-
...
;;; Needs  Emacs 24.1 or higher
(when (version< emacs-version "24.1")
  (error "This Elisp code requires Emacs 24.1 or later"))
